// utils.js — Doucite v3.2.0 (name parsing, dates, sentence case smart, helpers)
...
window.CiteUtils = (function () {
  ...
  function normalizeDate(raw) {
    ...
    if (iso) {
      const y=iso[1]; const m=iso[2]?parseInt(iso[2],10):NaN; const d=iso[3]?parseInt(iso[3],10):NaN;
